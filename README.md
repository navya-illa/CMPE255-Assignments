...
- Applied the CRISP-DM methodology
- Classified six natural-scene categories
- Built and evaluated a custom CNN
- Used MobileNetV2 transfer learning and fine-tuning
...
- [Assignment 1 documentation](./Assignment-1/README.md)
- [Kaggle notebook](https://www.kaggle.com/code/navyai9/intel-scene-classification-with-deep-learning)
